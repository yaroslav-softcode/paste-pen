...
Вставка изображений из файла и из буфера с возможностью перемещения и пропорционального растягивания.  
...
Для вставки картинки из буфера обмены нажмите правой кнопкой мыши на кнопку Картинка.  
...
Inserting images from a file or the clipboard with the ability to move and proportionally resize them.  
...
To bring an inserted image to the front or send it to the back, right-click it in "Select" mode.  
To delete an inserted image, right-click it in "Select" mode.  
