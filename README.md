...
Вставка PNG изображений с возможностью перемещения и пропорционального растягивания.
Инструмент Скриншот с захватом выделенной области вместе с рисунками.
Поддержка работы на нескольких мониторах.
Автоматическое сохранение настроек (язык интерфейса).
Двуязычный интерфейс (Русский / English).
Плавающая анимированная панель инструментов с темной темой.
...
Установите зависимости: pip install PyQt5
Запустите файл: python paste_pen.py
📜 Лицензия
...
Inserting PNG images with the ability to move and proportionally resize them.
Screenshot tool capturing the selected area along with your drawings.
Multi-monitor support.
Automatic settings saving (interface language).
